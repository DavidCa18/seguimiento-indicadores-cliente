...
// esto cambia
      if(this.role != "UPDI_ROLE" && (this.indicadorModelo.estadoSolicitud == "RECHAZADA" || this.indicadorModelo.estadoSolicitud == "ENVIADA" || this.indicadorModelo.estadoSolicitud == "NULA")){
